//
//  FavoriteDelegationsViewController.m
//  MSP
//
...
#import "FavoriteDelegationsViewController.h"

#import "DelegationViewController.h"

@interface FavoriteDelegationsViewController ()

@end

@implementation FavoriteDelegationsViewController
...
- (void)loadData {
    ...
    for (int i = 1; i <= 5; i++)
    {
        ...
        [item setItem:[NSString stringWithFormat:@"Delegación favorita %d", i]];
